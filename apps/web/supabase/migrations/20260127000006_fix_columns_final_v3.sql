-- SUPER FINAL DATABASE REPAIR (V3)
-- Solves "cannot alter type of a column used in a policy definition" for multiple tables.

-- A. DROP ALL DEPENDENT POLICIES
-- 1. Wallet
...
BEGIN
  ...
  ELSE
      -- Ensure it is INTEGER (might be UUID if created wrongly before)
...
-- Restore Public Views (Just in case they were dropped)
